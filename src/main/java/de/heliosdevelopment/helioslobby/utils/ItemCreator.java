...
public class ItemCreator {
	...
	@Deprecated
	public ItemCreator(Material Material, String Amount) {
		item = new ItemStack(Material, Integer.valueOf(Amount));
	}
	...
	public ItemCreator addEnchantment(Enchantment Enchantment, String Level) {
		ItemMeta itemmeta = item.getItemMeta();
		itemmeta.addEnchant(Enchantment, Integer.valueOf(Level), true);
		item.setItemMeta(itemmeta);
		return this;
	}
